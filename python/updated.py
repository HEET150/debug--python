...
#resolved some intendation error and added some lines
import sys
...
if __name__ == "__main__":
    ...
    original_lines = load_csv_data(filename, delimiter) #to make a copy so user can do filter again
    ...
    while True:
        ...
        if choice == 1:
            ...
            lines = filter_data(original_lines, column, value)
            print(tabulate(lines, headers="firstrow", tablefmt="grid"))

        elif choice == 3: #added another choice so user can exit the program
